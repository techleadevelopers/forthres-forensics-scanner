...
use ghost_scanner::config::ScannerConfig;
use ghost_scanner::reporter::{EndpointHealthSnapshot, ScannerStatusSnapshot};
use ghost_scanner::scanner::{self, ForkMode, ScanMode, ScanRequest, ScanStream};
use ghost_scanner::service;
...
async fn main() -> Result<()> {
    ...
    match cli.command {
        ...
        Command::Serve { host, port } => {
            ...
            service::serve_http(config, addr).await?;
        }
    }
